...
def LR_eigenvalues(M, max_iterations=500, tol=1e-10, verbose=False):
    ...
    for i in range(max_iterations):
        ...
        # the previous iterations U is lower than the tol value stated, and if so, returns the diagonal of the U as the eigenvalues.
...
# Replace the square matrix A below with the square matrix you wish to find the real eigenvalues of.
